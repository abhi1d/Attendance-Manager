...
public class Lab extends HttpServlet {
 ...
 try {
	pstmt=(PreparedStatement) con.prepareStatement("select * from "+database_name+"Lab where name='"+s_name+"'");
 ...
 {
 try {
	pstmt = (PreparedStatement) con.prepareStatement("insert into "+database_name+"Lab values('"+s_name+"','"+at+"')");
